...
5. The terminal should return the IP address for the webpage for monitoring the ESP32
...
This contains the HTML file for display purposes on the webserver. It would be automatically linked to the apps while running them.